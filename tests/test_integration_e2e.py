...
Game/
  ...
  SkyrimPrefs.ini
"""
        key_files = {"SkyrimSE.exe": "binary", "SkyrimPrefs.ini": "[Display]"}
...
class TestReliabilityWeighting(unittest.TestCase):
    ...
    def test_filter_by_reliability(self):
        ...
        sources = [
            {"url": "https://nexusmods.com/...", "type": "nexus_mods", "endorsements": 1000},
            {"url": "https://random-forum.com/...", "type": "forum_general", "endorsements": 0},
        ]
...
class TestPresentationLayer(unittest.TestCase):
    ...
    def test_latex_formatting(self):
        ...
        content = create_guide_content(
            ...
            sections=[{"title": "Installation", "content": "Step 1: Download..."}],
            warnings=[{"level": "high", "message": "Critical warning"}],
            recommendations=[{"priority": "high", "content": "Do this first"}],
            sources=[
...
class TestFeedbackSystem(unittest.TestCase):
    ...
    def test_self_improvement_logging(self):
        ...
        from feedback_service import get_self_improvement_log, log_issue, log_win
...
class TestFullUserWorkflow(unittest.TestCase):
    ...
    def test_complete_analysis_workflow(self):
        ...
        mod_list = ["USSEP.esm", "SkyUI.esp", "Ordinator - Perks of Skyrim.esp"]
