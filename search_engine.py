...
_TYPO_MAP = {
    'ordinator': ['ordinator', 'ordinatior'],
    'immersive': ['immersive', 'imersive', 'immerssive'],
    'unofficial': ['unofficial', 'unoffical', 'unofficail'],
    'alternate': ['alternate', 'alternative', 'alternet'],
    'relationship': ['relationship', 'relation', 'relationship dialogue'],
    'cutting': ['cutting', 'cutting room floor', 'crf'],
    'falskaar': ['falskaar', 'falskar'],
    'dragonborn': ['dragonborn', 'dragon born'],
    'dawnguard': ['dawnguard', 'dawn guard'],
    'hearthfire': ['hearthfire', 'hearth fire', 'hearthfires'],
    'skyui': ['skyui', 'sky ui', 'sky ui se'],
    'sseedit': ['sseedit', 'xedit', 'tes5edit'],
}
