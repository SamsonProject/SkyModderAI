...
TOOLS = {
    'nexus': {'name': 'Nexus Mods', 'url': 'https://www.nexusmods.com/', 'desc': 'Mod downloads for all Bethesda games'},
    'loot': {'name': 'LOOT', 'url': 'https://loot.github.io/', 'desc': 'Load order optimizer (desktop app)'},
    'xedit': {'name': 'xEdit', 'url': 'https://tes5edit.github.io/', 'desc': 'SSEEdit, FO4Edit, FNVEdit, etc. For cleaning and conflict resolution'},
    'wabbajack': {'name': 'Wabbajack', 'url': 'https://www.wabbajack.org/', 'desc': 'One-click mod list installer'},
}

# Mod managers — Vortex is site-wide; MO2 has primary Nexus page (Skyrim SE)
MOD_MANAGERS = {
    'mo2': {'name': 'Mod Organizer 2 (MO2)', 'url': 'https://www.nexusmods.com/skyrimspecialedition/mods/6194', 'desc': 'Popular mod manager for Bethesda games'},
    'vortex': {'name': 'Vortex', 'url': 'https://www.nexusmods.com/site/mods/1', 'desc': 'Nexus official mod manager'},
}

# Learning resources
LEARNING_RESOURCES = [
    {'name': 'GamerPoets', 'url': 'https://www.youtube.com/@GamerPoets', 'desc': 'Step-by-step tutorials on MO2, xEdit, conflict resolution. Skyrim & Fallout.'},
    {'name': 'Gopher', 'url': 'https://www.youtube.com/@GopherVids', 'desc': 'Classic Skyrim modding guides. MO2, LOOT, fundamentals.'},
    {'name': 'xEdit documentation', 'url': 'https://tes5edit.github.io/docs/', 'desc': 'Official docs for SSEEdit, FO4Edit. Cleaning, conflict resolution.'},
]

INTERNAL_LINKS = [
    {'name': 'Sign up', 'url': '/signup-pro', 'desc': 'Create your account before checkout.'},
    {'name': 'Profile', 'url': '/profile', 'desc': 'Manage sessions, API keys, and linked accounts.'},
    {'name': 'Pricing section', 'url': '/#pricing', 'desc': 'Compare Free, Pro, and OpenClaw Lab tiers.'},
]
...
GAME_QUICKSTART: Dict[str, Dict[str, Any]] = {
    'skyrimse': {
        ...
        'script_ext': {'name': 'SKSE', 'url': 'https://www.nexusmods.com/skyrimspecialedition/mods/30379', 'abbrev': 'SKSE'},
        'unofficial_patch': {'name': 'USSEP', 'url': 'https://www.nexusmods.com/skyrimspecialedition/mods/266'},
    ...
    'skyrim': {
        ...
        'unofficial_patch': {'name': 'USLEEP', 'url': 'https://www.nexusmods.com/skyrim/mods/71214'},
    ...
    'skyrimvr': {
        'name': 'Skyrim VR',
        'nexus_slug': 'skyrimspecialedition',
        'script_ext': {'name': 'SKSE VR', 'url': 'https://www.nexusmods.com/skyrimspecialedition/mods/30379', 'abbrev': 'SKSE'},
        'unofficial_patch': {'name': 'USSEP', 'url': 'https://www.nexusmods.com/skyrimspecialedition/mods/266'},
    ...
    'fallout3': {
        ...
        'nexus_slug': 'fallout3',
        'script_ext': None,
        'unofficial_patch': {'name': 'UFO3P', 'url': 'https://www.nexusmods.com/fallout3/mods/19122'},
    ...
    'fallout4': {
        'name': 'Fallout 4',
        'nexus_slug': 'fallout4',
        'script_ext': {'name': 'F4SE', 'url': 'https://www.nexusmods.com/fallout4/mods/42147', 'abbrev': 'F4SE'},
        'unofficial_patch': {'name': 'UFO4P', 'url': 'https://www.nexusmods.com/fallout4/mods/4598'},
    ...
    'starfield': {
        ...
        'script_ext': None,
        'unofficial_patch': {'name': 'Community Patch', 'url': 'https://www.nexusmods.com/starfield/mods/1'},
