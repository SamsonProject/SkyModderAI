...
from sponsor_service import get_sponsor_service, get_ranked_sponsors
...
def sponsors_list():
    ...
    return render_template('sponsors/list.html', 
                         sponsors=sponsors,
...
def apply():
    ...
    return render_template('sponsors/apply.html', 
...
def dashboard():
    ...
    return render_template('sponsors/dashboard.html',
                         sponsor=None,
                         metrics={},
                         billing={})
