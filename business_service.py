...
class BusinessService:
    ...
    def register_business(self, data: Dict[str, Any], owner_email: Optional[str] = None) -> Optional[str]:
        """
    ...
    def _recalculate_trust_score(self, business_id: str):
        ...
        try:
            ...
            db.execute("""
                ...
                WHERE business_id = ?
            """, (
                round(composite, 1), tier, total_votes, positive_votes,
                round(vote_score, 3), round(longevity_score, 3), round(flag_penalty, 1),
                business_id
            ))
